...
if(isset($_POST["b11"]))
{
    ...
    $obj->usreml=$_POST["txtemail"];
    $obj->usrpwd=$_POST["txtpwd"];
    $obj->usrrol='U';
    if($obj->save_rec()==TRUE)
    {
        $obj->save_rec();
        $msg="Registraion successful";
    } else {
        $msg="Email Id already regsitered";
...
<div class="mid-section">
  ...
  <div class="about-content">    
      <div class="heading"><h3>Registration Form:</h3>
      <form method="POST" action="frmreg.php">
          <table border="5" width="100%">
              ...
              <tr>
                  <td></td>
                  <td>
                      <input type="submit" value="submit" name="b11" />
                  </td>
              </tr>
          </table>
          <tr>
